...
function [vel_opt] = speedOpt_TFC_fmincon_partiallycentralized(Rho,par,v,vel,pos,v_neighbors,vel_neighbors,pos_neighbors)
...
[vel_opt,~,~,~] = fmincon(@(vel)Optimizer_TFC_fmincon_partiallycentralized(Rho,par,v,vel,pos,v_neighbors,vel_neighbors,pos_neighbors),x0,[],[],[],[],lb,ub,[],options);
