...
function [vel_opt] = speedOpt_TFC_fmincon_centralized(Rho,par,v,vel,pos)
...
[vel_opt,~,~,~] = fmincon(@(vel)Optimizer_TFC_fmincon_centralized(Rho,par,v,vel,pos),x0,[],[],[],[],lb,ub,[],options);
